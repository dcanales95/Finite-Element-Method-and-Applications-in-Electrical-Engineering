...
where 
- **$D_3$** is the electrical charge density
- **$d_{31}$** is the piezoelectric strain constant
- **$T_1$** is the stress generated in the length direction of the piezoelectric layer
- **$\varepsilon_{33}$** is the dielectric constant of the piezoelectric material under constant stress conditions
- **$E_3$** is the electric field developed in the “3” direction
